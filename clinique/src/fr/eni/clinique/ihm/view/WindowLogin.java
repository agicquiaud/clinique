...
public class WindowLogin {
	...
	private ImagePanel imgBack = new ImagePanel(new ImageIcon("ressource/login-color.jpg").getImage());
	...
	public WindowLogin() {
		...
		lblTre.setIcon(new ImageIcon("ressource/verrou.png"));
		lblTre.setBounds(77, 263, 24, 33);
		desktopPane.add(lblTre);
		
		JLabel lblNewLabel_1 = new JLabel("");
		lblNewLabel_1.setIcon(new ImageIcon("ressource/human-login.png"));
		lblNewLabel_1.setBounds(77, 214, 24, 33);
		desktopPane.add(lblNewLabel_1);
		
		JLabel lblNewLabel = new JLabel("");
		lblNewLabel.setIcon(new ImageIcon("ressource/logo-redi-login-sf.png"));
