...
public class WindowRemove {
	...
	WindowRemove(Object obj) {
		...
		PopupDelete.setLayout(gbl_PopupDeleteClient);
		...
		PopupDelete.add(lbltesvousSurDe, gbc_lbltesvousSurDe);
		...
		PopupDelete.add(btnPopupDelete, gbc_btnPopupDelete);
		...
		PopupDelete.add(btnPopupCancelDelete, gbc_btnPopupCancelDelete);
